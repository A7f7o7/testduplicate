...
var PreambleSubtitles = [''];

var FirstMenuSubtitles = [
  '',
  'Bill of Rights',
  'Legislative',
  'Executive',
  ...
  'Militia',
  'Country and Township Organizations',
  'Apportionment',
...
var Article1Subtitles = [
  ...
  'Right to assemble',
  'Bearing arms; standing armies; military powers',
  'Trial by jury',
  ...
  'Property rights in ground water, lakes, and other watercourses',
...
var Article2Subtitles = [
  ...
  'Election and terms of legislators',
  'Residence',
  'Eligibility',
  ...
  'Vacancies in either house, how filled',
  'Privilege of members from arrest, and of speech',
  'When session to be public',
  'Power of adjournment',
  'How bill shall be passed',
  ...
  'Who liable to impeachment. and punishment',
  'Repealed',
  'What laws and have a uniform operation',
...
var Article3Subtitles = [
  ...
  'Lieutenant governor duties assigned by governor',
  'Term of office',
  'Elections returns',
  'Repealed',
  'Executive power vested in governor',
  'He may require written information, etc.',
  'He shall recommend measures, etc.',
  'Limiting part of General Assembly in extra session',
  'When he may adjourn the General Assembly',
  'Commander-in-chief of militia',
  'May grant reprieves, commutations and pardons',
  'Seal of the state, and by whom kept',
  'How grants and commisions issued',
  ...
  'What vacancies governor to fill',
  'Compensation',
  'Officers to report the governor, and when',
  'Appointment subject to advice and consent of Senate',
  'Jurisdiction to determine disability; succession'
];
...
var Article4Subtitles = [
  ...
  'Repealed',
  'Number of judges may be increased or diminished; districts altered, and other courts established',
  'Repealed',
  'Judges removable',
  'Powers and jurisdiction',
  'Courts and conciliation',
...
var Article6Subtitles = [
  ...
  'Guaranteed loans to residents attending colleges and universities',
...
var Article8Subtitles = [
  'Public debt',
  'Additional, and for what purposes',
  'Repealed',
  'Adjusted compensation for service in World War II',
  'Construction of state highway system',
  'Korean War bonus',
  'Providing means for securing funds for highway and public building construction',
  'Authorizing bond issue to provide school classrooms, support for universities, for recreation and conservation and for state buildings',
  'Authorizing bond issue or other obligations for highway construction',
  'Bond issue for development',
  'Capital improvement bonds',
  'Vietnam conflict compensation fund',
  'Issuance of bonds for local government public infrastructure capital improvement',
  'Parks, recreation, and natural resources project capital improvements',
  'Issuance of general obligations',
  'Facilities for system of common schools and facilities for state-supported and state-assisted institutions of higher education',
  'Issuance of bonds and other oblications for environmental conservation and revitalization purposes',
  'Issuance of bonds for economic and educational purposes and local government projects',
  'Issuance of bonds for environmental revitalization and conservation',
  'Issue bonds to provide compensation to veterans of the Persian Gulf, Afghanistan, and Iraq conflicts',
  'Issuance of additional general obligation bonds to fund public infrastructure capital improvements',
  ...
  'Financing of certain housing; revenue bonds, loans from corporations',
  'State assistance to development of coal technology',
  'State and political subdivisions to provide housing for individuals',
...
var Article12Subtitles = [
  ...
  'Authority to classify real estate for taxation, two classes; procedures',
  'Imposition of taxes',
  'Revenue',
  'Levying of taxes',
...
var Article13Subtitles = [
  ...
  'Dues from corporations; how secured; inspection of private banks',
...
var Article15Subtitles = [
  ...
  'Who eligibile to office',
  'Repealed',
  'Lotteries, charitable bingo, casinos',
  'Oath of officers',
  'Repealed',
  'Repealed',
  'Repealed',
...
var Article18Subtitles = [
  ...
  'Acquisition by ordinance; procedure; referendum; submission',
  'Sale of surplus',
  'Home rule',
...
var LengthList = [
  PreambleSections.length,
  Article1Sections.length,
  Article2Sections.length,
  Article3Sections.length,
  Article4Sections.length,
  Article5Sections.length,
  Article6Sections.length,
  Article7Sections.length,
  Article8Sections.length,
  Article9Sections.length,
  Article10Sections.length,
  Article11Sections.length,
  Article12Sections.length,
  Article13Sections.length,
  Article14Sections.length,
  Article15Sections.length,
  Article16Sections.length,
  Article17Sections.length,
...
var ArticleHeaders = [
  ...
  'Aritcle VIII Sections',
  'Article IX Sections',
  'Article X Sections',
  'Article XI Sections',
  'Article XII Sections',
  'Aritcle XIII Sections',
...
var Content = {
  ...
  SecondMenuTitlesList[7][2]:
      'The governor shall have power to fill all vacancies that may occur in the offices aforesaid, until the next session of the General Assembly, and, until a successor to his appointee shall be confirmed and qualified.',
  SecondMenuTitlesList[8][0]:
  ...
  SecondMenuTitlesList[8][2]:
      'This section referred to adjusted compensation for service in World War I.',
  SecondMenuTitlesList[8][3]:
  ...
  SecondMenuTitlesList[8][30]:
      'This section provided for a superintendent of public works.',
  SecondMenuTitlesList[8][31]:
  ...
  SecondMenuTitlesList[10][4]:
    ...
    The foregoing provisions of this section shall be self-executing except as herein otherwise provided.
      ''',
  SecondMenuTitlesList[10][5]: 'Referred to removal of officers',
  SecondMenuTitlesList[10][6]: 'Referred to local taxation.',
  SecondMenuTitlesList[11][0]:
  ...
  SecondMenuTitlesList[11][8]:
      ...
      ''',
  SecondMenuTitlesList[11][9]:
      'The various provisions of this article are intended to be severable, and the invalidity of one or more of such provisions shall not affect the validity of the remaining provisions.',
  SecondMenuTitlesList[11][10]:
      'This section referred to the composition of Ohio Senate districts.',
  SecondMenuTitlesList[11][11]:
      'This section referred to changes in the boundaries of Ohio Senate districts.',
  SecondMenuTitlesList[11][12]:
      'This section referred to legal challenges to redistricting plans.',
  SecondMenuTitlesList[11][13]:
  ...
  SecondMenuTitlesList[18][10]:
      'Any municipality appropriating private property for a public improvement may provide money therefor in part by assessments upon benefited property not in excess of the special benefits conferred upon such property by the improvements. Said assessments, however, upon all the abutting, adjacent, and other property in the district benefited, shall in no case be levied for more than fifty per centum of the cost of such appropriation.',
  SecondMenuTitlesList[18][11]:
  ...
  SecondMenuTitlesList[19][0]:
      '''(A) Except as otherwise provided in this section, the general assembly shall be responsible for the redistricting of this state for congress based on the prescribed number of congressional districts apportioned to the state pursuant to Section 2 of Article I of the Constitution of the United States.
      ...
      ''',
  SecondMenuTitlesList[19][1]:
      '''(A)(1) Each congressional district shall be entitled to a single representative in the United States house of representatives in each congress.
  ...
  SecondMenuTitlesList[22][0]:
       'Special thanks to the Ohio State Bar Association and its Chief Justice Thomas J. Moyer Fellowship Program for supporting and funding the development of this phone app. ',
};

  /*
  Newline escape character: /n : remember to do two for indentation
  Escape character for apostrophes and such: / 
  */ 